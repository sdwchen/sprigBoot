...
(function ($) {
    ...
    function _33(_34, pp, _35) {
        ...
        pp.panel($.extend({}, _35, {
            ...
            closed: true,
            doSize: false,
            iconCls: (_35.icon ? _35.icon : undefined),
            onLoad: function () {
                if (_35.onLoad) {
    ...
    $.fn.tabs = function (_6d, _6e) {
        ...
        return this.each(function () {
            ...
            if (_6f) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _6d),
                    tabs: [],
                    selectHis: []
                });
                _23(this);
    ...
    $.fn.tabs.parseOptions = function (_7d) {
        return $.extend({}, $.parser.parseOptions(_7d, ["width", "height", "tools", "toolPosition", "tabPosition", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean",
            headerWidth: "number",
