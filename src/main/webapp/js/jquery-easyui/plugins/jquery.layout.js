...
(function ($) {
    ...
    function _2f(_30, _31, _32) {
        ...
        function _35(dir) {
            ...
            var _3a = $.extend({}, $.fn.layout.paneldefaults, {
        ...
        function _37() {
            ...
            if (_31 == "east") {
                ...
                return {
                    resizeC: {width: _3b.width + _3c.width - 28},
                    expand: {left: cc.width() - _3c.width},
                    expandP: {top: _3b.top, left: cc.width() - 28, width: 28, height: _3b.height},
                ...
                if (_31 == "west") {
                    ...
                    return {
                        resizeC: {width: _3b.width + _3d.width - 28, left: 28},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3b.top, width: 28, height: _3b.height},
                        collapse: {left: -_3d.width, top: _3b.top, height: _3b.height}
                    };
                } else {
                    if (_31 == "north") {
                        var hh = cc.height() - 28;
                        ...
                        return {
                            ...
                            collapse: {top: -_33["north"].panel("options").height, width: cc.width()}
                        };
                    } else {
                        if (_31 == "south") {
                            var hh = cc.height() - 28;
        ...
        function _43() {
            ...
            if (_40 == "east" && _41.expandEast) {
                return {
                    ...
                    expand: {left: cc.width() - _41["east"].panel("options").width}
                };
            } else {
                if (_40 == "west" && _41.expandWest) {
                    return {
                        collapse: {left: -_41["west"].panel("options").width, top: _45.top, height: _45.height},
                        expand: {left: 0}
                    };
                } else {
                    if (_40 == "north" && _41.expandNorth) {
                        return {
                            collapse: {top: -_41["north"].panel("options").height, width: cc.width()},
                            expand: {top: 0}
                        };
                    } else {
                        if (_40 == "south" && _41.expandSouth) {
                            return {
                                collapse: {top: cc.height(), width: cc.width()},
                                expand: {top: cc.height() - _41["south"].panel("options").height}
                            };
                        }
                    }
                }
