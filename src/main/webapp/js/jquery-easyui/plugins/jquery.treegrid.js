...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_ab) {
                ...
                _ab = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _a8),
                    data: []
                });
            }
            _1(this);
    ...
    var _bc = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, view: _bc, loader: function (_101, _102, _103) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _101, dataType: "json", success: function (data) {
                    _102(data);
                }, error: function () {
