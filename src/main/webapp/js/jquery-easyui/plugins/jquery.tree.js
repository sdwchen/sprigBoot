...
(function ($) {
    ...
    function _52(_53, ul, _54, _55) {
        ...
        function _5a(ul, _5d, _5e) {
            for (var i = 0; i < _5d.length; i++) {
                ...
                $.data(_60[0], "tree-node", {
                    id: _5f.id,
                    text: _5f.text,
                    iconCls: _5f.iconCls,
                    attributes: _5f.attributes
                });
    ...
    function _14(_d2, _d3) {
        var _d4 = $.extend({}, $.data(_d3, "tree-node"), {
            target: _d3,
            checked: $(_d3).find(".tree-checkbox").hasClass("tree-checkbox1")
        });
        if (!_4d(_d2, _d3)) {
    ...
    $.fn.tree.parseOptions = function (_112) {
        var t = $(_112);
        return $.extend({}, $.parser.parseOptions(_112, ["url", "method", {
            checkbox: "boolean",
    ...
    $.fn.tree.defaults = {
        ...
        loader: function (_113, _114, _115) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _113, dataType: "json", success: function (data) {
                    _114(data);
                }, error: function () {
