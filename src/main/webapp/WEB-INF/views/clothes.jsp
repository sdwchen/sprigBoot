...
<head>
    ...
    <script type="text/javascript" src="/js/views/clothes.js"></script>
</head>
<body>

<div id="clothes_dialog">
    <form id="clothes_form" method="post">
        <table align="center" style="margin-top:15px">
            <input type="hidden" name="id">
            <tr>
                <td>订单id</td>
                <td><input class="easyui-combobox" name="dingdan.clothesid"
                           data-options=" url:'/dingdan_queryForEmp',editable:false,valueField:'clothesid',textField:'id'">
                </td>
...
<table id="clothes_datagrid"></table>
<div id="clothes_datagrid_tb">
    <div>
