...
<head>
    ...
    <script type="text/javascript" src="/js/views/beforuser.js"></script>
</head>
<body>

<div id="beforuser_dialog">
    <form id="beforuser_form" method="post">
...
<table id="beforuser_datagrid"></table>
<div id="beforuser_datagrid_tb">
    <div>
