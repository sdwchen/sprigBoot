...
<head>
    ...
    <script type="text/javascript" src="/js/views/others.js"></script>
</head>
<body>

<div id="others_dialog">
    <form id="others_form" method="post">
        <table align="center" style="margin-top:15px">
            <input type="hidden" name="id">
            <tr>
                <td>订单id</td>
                <td><input class="easyui-combobox" name="dingdan.othersid"
                           data-options=" url:'/dingdan_queryForEmp',editable:false,valueField:'othersid',textField:'id'">
                </td>
...
<table id="others_datagrid"></table>
<div id="others_datagrid_tb">
    <div>
